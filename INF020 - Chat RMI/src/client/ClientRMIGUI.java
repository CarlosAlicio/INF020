...
public class ClientRMIGUI extends JFrame implements ActionListener {
    ...
    public ClientRMIGUI() {
        ...
        frame = new JFrame("INF020 - Chat RMI");
        ...
        frame.addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosing(java.awt.event.WindowEvent windowEvent) {
                ...
                if (chatClient != null) {
                    try {
                        sendMessage("Tchau! Eu estou saindo do Chat.");
                        chatClient.serverIF.deixarChat(name);
    ...
    public JPanel getTextPanel() {
        String welcome = "Informe um Apelido para começar\n";
    ...
    public JPanel getUsersPanel() {
        ...
        String userStr = " Usuários Conectados     ";

        JLabel userLabel = new JLabel(userStr, JLabel.CENTER);
        userPanel.add(userLabel, BorderLayout.NORTH);
        userLabel.setFont(new Font("Meiryo", Font.PLAIN, 16));

        String[] noClientsYet = {"Sem outro Usuário"};
        ...
        try {
            if (e.getSource() == startButton) {
                ...
                if (name.length() != 0) {
                    ...
                    JOptionPane.showMessageDialog(frame, "Informe um Apelido para começar");
                }
            }
            ...
            if (e.getSource() == privateMsgButton) {
                ...
                for (int i = 0; i < privateList.length; i++) {
                    System.out.println("Selecionando Inice :" + privateList[i]);
                }
                message = textField.getText();
                textField.setText("");
    ...
    private void sendMessage(String chatMessage) throws RemoteException {
        chatClient.serverIF.atualizarChat(name, chatMessage);
    }

    private void sendPrivate(int[] privateList) throws RemoteException {
        String privateMessage = "[Mensagem Privada de " + name + "] :" + message + "\n";
        chatClient.serverIF.mensagemPrivada(privateList, privateMessage);
    }
